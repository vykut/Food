...
public struct NutritionalValuesCalculator {
    ...
    public func nutritionalValues(for meal: Meal) -> Ingredient {
    ...
    public func nutritionalValuesPerServingSize(for meal: Meal) -> Ingredient {
        guard meal.servings != 1 else { return nutritionalValues(for: meal) }
